...
\@x{}%
\@y{\@s{2.5}%
 \ensuremath{\.{\land} \A\, MS1}, \ensuremath{MS2 \.{\in} Majority} :
 \ensuremath{MS1 \.{\cap} MS2 \.{\neq} \{\}
}}%
\@xx{}%
\begin{lcom}{28.7}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\@x{\@s{144.34} \.{\land} m . acc\@s{6.60} \.{\in} MS \}}%
 \@x{\@s{46.93} maxbal \.{\defeq} Maximum ( \{ m . bal \.{:}\@s{4.1} m \.{\in}
 mset \} )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 18:50:40 \ensuremath{CEST} 2021 by \ensuremath{rchaves
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Aug} 07 18:09:11
