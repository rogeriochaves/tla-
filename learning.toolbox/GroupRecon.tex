...
\@x{}\moduleLeftDash\@xx{ {\MODULE} GroupRecon}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} Integers}%
\@pvspace{8.0pt}%
 \@x{ {\VARIABLE} withdrawStream ,\, clientAPIDatabase ,\, groupReconConsumer
 ,\, groupReconPayouts}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq} withdrawStream \.{=} \{ 1 ,\, 2 ,\, 3 \}}%
\@x{\@s{16.81} \.{\land}\@s{7.77} clientAPIDatabase \.{=} \{ \}}%
\@x{\@s{16.81} \.{\land}\@s{7.77} groupReconConsumer \.{=} \{ \}}%
\@x{\@s{16.81} \.{\land}\@s{7.77} groupReconPayouts \.{=} \{ \}}%
\@pvspace{8.0pt}%
\@x{ TypeOK \.{\defeq} withdrawStream \.{\subseteq} Nat}%
 \@x{\@s{37.25} \.{\land}\@s{7.77} clientAPIDatabase \.{\subseteq}
 withdrawStream}%
 \@x{\@s{37.25} \.{\land}\@s{7.77} groupReconConsumer \.{\subseteq}
 withdrawStream}%
 \@x{\@s{37.25} \.{\land}\@s{7.77} groupReconPayouts \.{\subseteq}
 groupReconConsumer}%
 \@x{\@s{37.25} \.{\land}\@s{7.77} groupReconPayouts \.{\subseteq}
 clientAPIDatabase}%
\@pvspace{8.0pt}%
\@x{ ClientAPIConsume \.{\defeq} clientAPIDatabase \.{\neq} withdrawStream}%
 \@x{\@s{85.26} \.{\land}\@s{7.77} clientAPIDatabase \.{'} \.{=}
 clientAPIDatabase \.{\cup} withdrawStream [ 0 ]}%
 \@x{\@s{85.26} \.{\land}\@s{7.77} {\UNCHANGED} {\langle} withdrawStream ,\,
 groupReconConsumer ,\, groupReconPayouts {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ GroupReconWithdrawConsume \.{\defeq} groupReconConsumer \.{\neq}
 withdrawStream}%
 \@x{\@s{135.65} \.{\land}\@s{7.77} groupReconConsumer \.{'} \.{=}
 groupReconConsumer \.{\cup} withdrawStream [ 0 ]}%
 \@x{\@s{135.65} \.{\land}\@s{7.77} {\UNCHANGED} {\langle} withdrawStream ,\,
 clientAPIDatabase ,\, groupReconPayouts {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ GeneratePayouts \.{\defeq} groupReconPayouts \.{\neq}
 groupReconConsumer}%
 \@x{\@s{74.75} \.{\land}\@s{7.77} groupReconPayouts \.{'} \.{=}
 groupReconPayouts \.{\cup} groupReconConsumer [ 0 ]}%
\@y{\@s{0}%
 \ensuremath{\{ p \.{\in} groupReconConsumer \.{:} p \.{\in}
 clientAPIDatabase \}
}}%
\@xx{}%
 \@x{\@s{74.75} \.{\land}\@s{7.77} {\UNCHANGED} {\langle} withdrawStream ,\,
 groupReconConsumer ,\, clientAPIDatabase {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} ClientAPIConsume}%
\@x{\@s{20.94} \.{\lor}\@s{7.77} GroupReconWithdrawConsume}%
\@x{\@s{20.94} \.{\lor}\@s{7.77} GeneratePayouts}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Aug} 07
 19:18:12 \ensuremath{CEST} 2021 by \ensuremath{rchaves
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Aug} 07 18:53:17
